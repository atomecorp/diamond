          ...
          if (node.operator === "=") {
            if (node.left.type === "MemberExpression") {
              if (node.left.computed) {
                ...
                if (node.left.object && node.left.object.type === "Identifier" && context.methodType === "static" && this.isMethodName(node.left.object.name, context)) {
                ...
                const rightExpr2 = this.emitExpression(node.right, context);
                const methodName = `${node.left.property.name}=`;
                return `${objectCode}[${this.quote(methodName)}](${rightExpr2})`;
              }
            }
...
${indent}if (typeof globalThis !== "undefined") { globalThis.${methodName} = ${methodName}; }`;
  ...
  var require_transpiler = __commonJS({
    "src/transpiler.js"(exports, module) {
      ...
      var api = { transpile, Tokenizer, Parser, Emitter };
...
//# sourceMappingURL=diamond.browser.js.map
